...
public class SignupProfessor extends javax.swing.JFrame {

    MySQL conectar = new MySQL();
    CadastroProfessor novoCliente = new CadastroProfessor();
    public SignupProfessor() {
        initComponents();
        
        this.setTitle("Cadastro Professor");
    ...
    private void deletarCliente(CadastroProfessor novoCliente){
    ...
    private void cadastraCliente(CadastroProfessor novoCliente){
        this.conectar.conectaBanco(); 
        ...
        int aula_prof_fk = auxInstrument();
        try {
               
            System.out.println(aula_prof_fk);
            this.conectar.insertSQL("INSERT INTO professor ("
                    + "nome,"
                    + "sobrenome,"
                    + "cpf,"
                    + "email,"
    ...
    private void buscarCliente(CadastroProfessor novoCliente){
        this.conectar.conectaBanco();
        int aula_prof_fk = 0;
        String consultaCpf = this.consultaCpf.getText();
        ...
        try {
            ...
            while(this.conectar.getResultSet().next()){
                ...
                aula_prof_fk = this.conectar.getResultSet().getInt(12);
           }
    ...
    public void atualizarCliente(CadastroProfessor novoCliente){
        this.conectar.conectaBanco();
        int aula_prof_fk = auxInstrument();
        String consultaCpf = this.consultaCpf.getText();
        String dataNasc = auxDateMySQL();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignupProfessor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SignupProfessor().setVisible(true);
            }
        });
    }
